...
exports.collectRouteInventory = collectRouteInventory;
...
function regexPathToString(regexp) {
...
function extractRoutesFromStack(stack, prefix, inheritedMiddlewares = []) {
    const routes = [];
...
function collectRouteInventory(app) {
