...
export default async function BestSellingProducts() {
  ...
  const products = (bestSelling.length ? bestSelling : pool).slice(0, 4);
    ...
    <section className="bg-white py-12 sm:py-16">
      <Container className="space-y-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-zinc-600">Mais vendidos</p>
            <h2 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900">Produtos mais vendidos</h2>
          </div>
        </div>
