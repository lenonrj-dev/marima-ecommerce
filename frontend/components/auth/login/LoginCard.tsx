...
export default function LoginCard({ reason }: { reason?: string }) {
  ...
  return (
    <div className="rounded-[28px] bg-white/35 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.18)] ring-1 ring-black/10 backdrop-blur-xl sm:p-7 md:min-h-[455px]">
      ...
      <div className="mt-8 flex items-center justify-between gap-4">
        ...
        <button
          type="button"
          className="inline-flex h-9 items-center gap-2 rounded-full bg-white/60 px-4 text-xs font-semibold text-zinc-700 ring-1 ring-black/10 backdrop-blur-md transition hover:bg-white/75 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/20"
