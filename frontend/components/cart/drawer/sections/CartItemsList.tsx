    ...
    <div className="space-y-4 overflow-x-hidden">
      {items.map((it) => {
        ...
        return (
          <div
            key={it.id}
            className="overflow-hidden rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm sm:p-4"
          >
            <div className="flex min-w-0 items-start gap-3 sm:gap-4">
              <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-xl bg-zinc-100 ring-1 ring-black/5">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex min-w-0 items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <p className="break-words text-sm font-semibold text-zinc-900 sm:truncate">{it.name}</p>
                    {it.variant ? (
                      <p className="mt-0.5 break-words text-xs text-zinc-600 sm:truncate">{it.variant}</p>
                    ) : null}
                  </div>
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-zinc-200 bg-white text-zinc-900 transition hover:bg-zinc-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/20"
                ...
                <div className="mt-3 flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex min-w-0 items-center justify-between gap-2 sm:justify-end">
                    <div className="inline-flex shrink-0 items-center rounded-full border border-zinc-200 bg-white">
                      <button
                        type="button"
                      ...
                      <span className="min-w-[40px] text-center text-sm font-semibold text-zinc-900">{it.qty}</span>
